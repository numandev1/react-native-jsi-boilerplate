...
#include "pthread.h"
#include <sys/types.h>
#include "react-native-jsi-boilerplate.h"
...
Java_com_reactnativejsiboilerplate_JsiBoilerplateModule_nativeInstall(JNIEnv *env, jobject clazz, jlong jsiPtr)
{
    env->GetJavaVM(&java_vm);
    java_object = env->NewGlobalRef(clazz);
